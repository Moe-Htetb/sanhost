...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $cs3224 = isset($_POST['CS-3224']) ? trim($_POST['CS-3224']) : null;
    ...
    $check_query = "SELECT * FROM third_2sem_cs WHERE roll_no = ?";
    ...
    $query = "INSERT INTO third_2sem_cs (roll_no, `CST-3211`, `CST-3242`, `CST-3213`, `CS-3224`, `CST-3235`, `CST-3256`, `CST-3257`) 
              VALUES (?, ?, ?, ?, ?, ?, ?, ?)";

    $stmt = mysqli_prepare($conn, $query);
    mysqli_stmt_bind_param($stmt, 'ssssssss', $roll_no, $cst3211, $cst3242, $cst3213, $cs3224, $cst3235, $cst3256, $cst3257);
