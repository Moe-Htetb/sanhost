...
// Fetch fifth year first semester CT data with student names by joining tables
$query = "SELECT s.*, st.name 
          FROM fifth_1sem_ct s
          LEFT JOIN students st ON s.roll_no = st.roll_no
          ORDER BY s.roll_no ASC";
$result = mysqli_query($conn, $query);

$rollNumberQuery = "SELECT roll_no FROM students where semester = 'First Semester' and year = 'Fifth Year' and major = 'Computer Technology' ORDER BY roll_no ASC";
...
<div class="p-4 sm:ml-64">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
        <span class="text-2xl font-bold text-gray-800">Fifth Year <small>(First Semester Results)</small></span>
        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                <tr>
                    ...
                    <th scope="col" class="px-6 py-3">E-5101</th>
                    <th scope="col" class="px-6 py-3">CST-5141</th>
                    <th scope="col" class="px-6 py-3">CST-5102</th>
                    <th scope="col" class="px-6 py-3">CT-5133</th>
                    <th scope="col" class="px-6 py-3">CT-5134</th>
                    <th scope="col" class="px-6 py-3">CS-5135</th>
            ...
            <tbody>
                <?php while ($row = mysqli_fetch_assoc($result)): ?>
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <td class="px-6 py-4">
                            <?php echo htmlspecialchars($row['E-5101']); ?>
                        </td>
                        <td class="px-6 py-4">
                            <?php echo htmlspecialchars($row['CST-5141']); ?>
                        </td>
                        <td class="px-6 py-4">
                            <?php echo htmlspecialchars($row['CST-5102']); ?>
                        </td>
                        <td class="px-6 py-4">
                            <?php echo htmlspecialchars($row['CT-5133']); ?>
                        </td>
                        <td class="px-6 py-4">
                            <?php echo htmlspecialchars($row['CT-5134']); ?>
                        </td>
                        <td class="px-6 py-4">
                            <?php echo htmlspecialchars($row['CS-5135']); ?>
                        </td>
                        <td class="px-6 py-4 text-right">
                            <div class="flex justify-end space-x-2">
                                <a href="#" onclick="openEditModal(
                                        ...
                                        '<?php echo addslashes($row['E-5101']); ?>',
                                        '<?php echo addslashes($row['CST-5141']); ?>',
                                        '<?php echo addslashes($row['CST-5102']); ?>',
                                        '<?php echo addslashes($row['CT-5133']); ?>',
                                        '<?php echo addslashes($row['CT-5134']); ?>',
                                        '<?php echo addslashes($row['CS-5135']); ?>'
    ...
    <div class="relative w-full max-w-2xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                ...
                <button data-modal-hide="add-result-modal" type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" >
            ...
            <div class="p-6 space-y-4">
                <form id="add-result-form" action="add_result_fifth1sem_ct.php" method="POST">
                    ...
                    dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        ...
                        <div>
                            <label for="add-e1" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                Professional English (E-5101)
                            </label>
                            <input type="number" id="add-e1" name="E-5101" min="0" max="100"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg 
                    focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 
                    dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 
                    dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        ...
                        <div>
                            <label for="add-cst1" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                Advanced Database Systems (CST-5141)
                            </label>
                            <input type="number" id="add-cst1" name="CST-5141" min="0" max="100"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg 
                    focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 
                    dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 
                    dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        ...
                        <div>
                            <label for="add-cst2" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                Cloud Computing (CST-5102)
                            </label>
                            <input type="number" id="add-cst2" name="CST-5102" min="0" max="100"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg 
                    focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 
                    dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 
                    dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        ...
                        <div>
                            <label for="add-ct1" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                Network Security (CT-5133)
                            </label>
                            <input type="number" id="add-ct1" name="CT-5133" min="0" max="100"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg 
                    focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 
                    dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 
                    dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        ...
                        <div>
                            <label for="add-ct2" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                Wireless Networks (CT-5134)
                            </label>
                            <input type="number" id="add-ct2" name="CT-5134" min="0" max="100"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg 
                    focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 
                    dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 
                    dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        ...
                        <div>
                            <label for="add-cs1" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                Distributed Systems (CS-5135)
                            </label>
                            <input type="number" id="add-cs1" name="CS-5135" min="0" max="100"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg 
                    focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 
                    dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 
                    dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
    ...
    <div class="relative w-full max-w-2xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button" id="closeAddResultBtn" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="edit-result-modal">
                    <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" />
                    </svg>
                    <span class="sr-only">Close modal</span>
            ...
            <!-- Modal body -->
            <div class="p-6 space-y-4">
                <form id="edit-result-form" action="update_result_fifth1sem_ct.php" method="POST">
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                            <label for="edit-e1" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Professional English (E-5101)</label>
                            <input type="number" id="edit-e1" min="0" max="100" name="E-5101" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        </div>
                        <div>
                            <label for="edit-cst1" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Advanced Database Systems (CST-5141)</label>
                            <input type="number" id="edit-cst1" min="0" max="100" name="CST-5141" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        </div>
                        <div>
                            <label for="edit-cst2" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Cloud Computing (CST-5102)</label>
                            <input type="number" id="edit-cst2" min="0" max="100" name="CST-5102" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        </div>
                        <div>
                            <label for="edit-ct1" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Network Security (CT-5133)</label>
                            <input type="number" id="edit-ct1" min="0" max="100" name="CT-5133" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        </div>
                        <div>
                            <label for="edit-ct2" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Wireless Networks (CT-5134)</label>
                            <input type="number" id="edit-ct2" min="0" max="100" name="CT-5134" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        </div>
                        <div>
                            <label for="edit-cs1" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Distributed Systems (CS-5135)</label>
                            <input type="number" id="edit-cs1" min="0" max="100" name="CS-5135" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        </div>
                    </div>
                </form>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.openEditModal = function(id, rollNo, e1, cst1, cst2, ct1, ct2, cs1) {
...
function confirmDelete(resultId) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location.href = 'delete_result_fifth1sem_ct.php?id=' + resultId;
        }
    });
}
</script>
