...
// Fetch fourth year second semester data with student names by joining tables
$query = "SELECT s.*, st.name 
          FROM fourth_2sem_cs s
          LEFT JOIN students st ON s.roll_no = st.roll_no
          ORDER BY s.roll_no ASC";
$result = mysqli_query($conn, $query);

$rollNumberQuery = "SELECT roll_no FROM students where semester = 'Second Semester' and year = 'Fourth Year' and major = 'Computer Science' ORDER BY roll_no ASC";
...
<div class="p-4 sm:ml-64">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
        <span class="text-2xl font-bold text-gray-800">Fourth Year <small>(Second Semester Results)</small></span>
        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                <tr>
                    ...
                    <th scope="col" class="px-6 py-3">CST-4211</th>
                    <th scope="col" class="px-6 py-3">CST-4242</th>
                    <th scope="col" class="px-6 py-3">CS-4223</th>
                    <th scope="col" class="px-6 py-3">CS-4214</th>
                    <th scope="col" class="px-6 py-3">CS-4225</th>
                    <th scope="col" class="px-6 py-3">CST-4257</th>
            ...
            <tbody>
                <?php while ($row = mysqli_fetch_assoc($result)): ?>
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <td class="px-6 py-4">
                            <?php echo htmlspecialchars($row['CST-4211']); ?>
                        </td>
                        <td class="px-6 py-4">
                            <?php echo htmlspecialchars($row['CST-4242']); ?>
                        </td>
                        <td class="px-6 py-4">
                            <?php echo htmlspecialchars($row['CS-4223']); ?>
                        </td>
                        <td class="px-6 py-4">
                            <?php echo htmlspecialchars($row['CS-4214']); ?>
                        </td>
                        <td class="px-6 py-4">
                            <?php echo htmlspecialchars($row['CS-4225']); ?>
                        </td>
                        <td class="px-6 py-4">
                            <?php echo htmlspecialchars($row['CST-4257']); ?>
                        </td>
                        <td class="px-6 py-4 text-right">
                            <div class="flex justify-end space-x-2">
                                <a href="#" onclick="openEditModal(
                                        ...
                                        '<?php echo addslashes($row['CST-4211']); ?>',
                                        '<?php echo addslashes($row['CST-4242']); ?>',
                                        '<?php echo addslashes($row['CS-4223']); ?>',
                                        '<?php echo addslashes($row['CS-4214']); ?>',
                                        '<?php echo addslashes($row['CS-4225']); ?>',
                                        '<?php echo addslashes($row['CST-4257']); ?>'
    ...
    <div class="relative w-full max-w-2xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-6 space-y-4">
                <form id="add-result-form" action="add_result_fourth2sem_cs.php" method="POST">
                    ...
                    dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        ...
                        <div>
                            <label for="add-cst1" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                Parallel and Distributed Computing (CST-4211)
                            </label>
                            <input type="number" id="add-cst1" name="CST-4211" min="0" max="100"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg 
                    focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 
                    dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 
                    dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        ...
                        <div>
                            <label for="add-cst2" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                Modeling & Simulation (CST-4242)
                            </label>
                            <input type="number" id="add-cst2" name="CST-4242" min="0" max="100"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg 
                    focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 
                    dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 
                    dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        ...
                        <div>
                            <label for="add-cs1" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                Software Design & Development (CS-4223)
                            </label>
                            <input type="number" id="add-cs1" name="CS-4223" min="0" max="100"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg 
                    focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 
                    dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 
                    dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        ...
                        <div>
                            <label for="add-cs2" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                Advanced Artificial Intelligence (CS-4214)
                            </label>
                            <input type="number" id="add-cs2" name="CS-4214" min="0" max="100"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg 
                    focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 
                    dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 
                    dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        ...
                        <div>
                            <label for="add-cs3" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                Advanced Database System (CS-4225)
                            </label>
                            <input type="number" id="add-cs3" name="CS-4225" min="0" max="100"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg 
                    focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 
                    dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 
                    dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        ...
                        <div>
                            <label for="add-cst3" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                Digital Business and E-Commerce Management (CST-4257)
                            </label>
                            <input type="number" id="add-cst3" name="CST-4257" min="0" max="100"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg 
                    focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 
                    dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 
                    dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
...
<div id="edit-result-modal" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full items-center justify-center bg-gray-900/50">
    <div class="relative w-full max-w-2xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <!-- Modal body -->
            <div class="p-6 space-y-4">
                <form id="edit-result-form" action="update_result_fourth2sem_cs.php" method="POST">
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                            <label for="edit-cst1" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Parallel and Distributed Computing (CST-4211)</label>
                            <input type="number" id="edit-cst1" min="0" max="100" name="CST-4211" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        </div>
                        <div>
                            <label for="edit-cst2" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Modeling & Simulation (CST-4242)</label>
                            <input type="number" id="edit-cst2" min="0" max="100" name="CST-4242" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        </div>
                        <div>
                            <label for="edit-cs1" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Software Design & Development (CS-4223)</label>
                            <input type="number" id="edit-cs1" min="0" max="100" name="CS-4223" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        </div>
                        <div>
                            <label for="edit-cs2" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Advanced Artificial Intelligence (CS-4214)</label>
                            <input type="number" id="edit-cs2" min="0" max="100" name="CS-4214" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        </div>
                        <div>
                            <label for="edit-cs3" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Advanced Database System (CS-4225)</label>
                            <input type="number" id="edit-cs3" min="0" max="100" name="CS-4225" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        </div>
                        <div>
                            <label for="edit-cst3" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Digital Business and E-Commerce Management (CST-4257)</label>
                            <input type="number" id="edit-cst3" min="0" max="100" name="CST-4257" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        </div>
                    </div>
                </form>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.openEditModal = function(id, rollNo, cst1, cst2, cs1, cs2, cs3, cst3) {
...
function confirmDelete(resultId) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location.href = 'delete_result_fourth2sem_cs.php?id=' + resultId;
        }
    });
}
</script>
