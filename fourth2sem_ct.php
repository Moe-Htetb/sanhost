...
$query = "SELECT s.*, st.name 
          FROM fourth_2sem_ct s
          LEFT JOIN students st ON s.roll_no = st.roll_no
          ORDER BY s.roll_no ASC";
$result = mysqli_query($conn, $query);

$rollNumberQuery = "SELECT roll_no FROM students where semester = 'Second Semester' and year = 'Fourth Year' and major = 'Computer Technology' ORDER BY roll_no ASC";
        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                <tr>
                    ...
                    <th scope="col" class="px-6 py-3">CT-4233</th>
                    <th scope="col" class="px-6 py-3">CT-4234</th>
                    <th scope="col" class="px-6 py-3">CT-4236</th>
            ...
            <tbody>
                <?php while ($row = mysqli_fetch_assoc($result)): ?>
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <td class="px-6 py-4">
                            <?php echo htmlspecialchars($row['CT-4233']); ?>
                        </td>
                        <td class="px-6 py-4">
                            <?php echo htmlspecialchars($row['CT-4234']); ?>
                        </td>
                        <td class="px-6 py-4">
                            <?php echo htmlspecialchars($row['CT-4236']); ?>
                        </td>
                        <td class="px-6 py-4">
                        ...
                        <td class="px-6 py-4 text-right">
                            <div class="flex justify-end space-x-2">
                                <a href="#" onclick="openEditModal(
                                        ...
                                        '<?php echo addslashes($row['CT-4233']); ?>',
                                        '<?php echo addslashes($row['CT-4234']); ?>',
                                        '<?php echo addslashes($row['CT-4236']); ?>',
    ...
    <div class="relative w-full max-w-2xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-6 space-y-4">
                <form id="add-result-form" action="add_result_fourth2sem_ct.php" method="POST">
                    ...
                    dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        ...
                        <div>
                            ...
                            <input type="number" id="add-ct1" name="CT-4233" min="0" max="100"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg 
                    focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 
                    dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 
                    dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        ...
                        <div>
                            ...
                            <input type="number" id="add-ct2" name="CT-4234" min="0" max="100"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg 
                    focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 
                    dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 
                    dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        ...
                        <div>
                            <label for="add-ct3" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                CT-4236
                            </label>
                            <input type="number" id="add-ct3" name="CT-4236" min="0" max="100"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg 
                    focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 
                    dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 
                    dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
...
<div id="edit-result-modal" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full items-center justify-center bg-gray-900/50">
    <div class="relative w-full max-w-2xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <!-- Modal body -->
            <div class="p-6 space-y-4">
                <form id="edit-result-form" action="update_result_fourth2sem_ct.php" method="POST">
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                            <label for="edit-cst1" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">CST-4211</label>
                        ...
                        <div>
                            <label for="edit-cst2" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">CST-4242</label>
                        ...
                        <div>
                            <label for="edit-ct1" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">CT-4233</label>
                            <input type="number" id="edit-ct1" min="0" max="100" name="CT-4233" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        </div>
                        <div>
                            <label for="edit-ct2" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">CT-4234</label>
                            <input type="number" id="edit-ct2" min="0" max="100" name="CT-4234" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        </div>
                        <div>
                            <label for="edit-ct3" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">CT-4236</label>
                            <input type="number" id="edit-ct3" min="0" max="100" name="CT-4236" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        </div>
                        <div>
                            <label for="edit-cst3" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">CST-4257</label>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.openEditModal = function(id, rollNo, cst1, cst2, ct1, ct2, ct3, cst3) {
        ...
        document.getElementById('edit-ct3').value = ct3;
...
function confirmDelete(resultId) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            window.location.href = 'delete_result_fourth2sem_ct.php?id=' + resultId;
        }
    });
}
</script>
