...
$query = "SELECT s.*, st.name 
          FROM third_1sem_cs s
          LEFT JOIN students st ON s.roll_no = st.roll_no
          ORDER BY s.roll_no ASC";
$result = mysqli_query($conn, $query);

$rollNumberQuery = "SELECT roll_no FROM students where semester = 'First Semester' and year = 'Third Year' and major = 'Computer Science' ORDER BY roll_no ASC";
        ...
        <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                <tr>
                    ...
                    <th scope="col" class="px-6 py-3 text-nowrap">CST-3131</th>
                    <th scope="col" class="px-6 py-3 text-nowrap">CST-3142</th>
                    <th scope="col" class="px-6 py-3 text-nowrap">CST-3113</th>
                    <th scope="col" class="px-6 py-3 text-nowrap">CS-3124</th>
                    <th scope="col" class="px-6 py-3 text-nowrap">CS-3125</th>
                    <th scope="col" class="px-6 py-3">CS(SK)-3156</th>
            ...
            <tbody>
                <?php while ($row = mysqli_fetch_assoc($result)): ?>
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <td class="px-6 py-4">
                            <?php echo htmlspecialchars($row['CS-3124']); ?>
                        </td>
                        <td class="px-6 py-4">
                            <?php echo htmlspecialchars($row['CS-3125']); ?>
                        </td>
                        <td class="px-6 py-4">
                            <?php echo htmlspecialchars($row['CS(SK)-3156']); ?>
                        </td>
                        <td class="px-6 py-4">
                        ...
                        <td class="px-6 py-4 text-right">
                            <div class="flex justify-end space-x-2">
                                <a href="#" onclick="openEditModal(
                                        ...
                                        '<?php echo addslashes($row['CS-3124']); ?>',
                                        '<?php echo addslashes($row['CS-3125']); ?>',
                                        '<?php echo addslashes($row['CS(SK)-3156']); ?>',
    ...
    <div class="relative w-full max-w-2xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-6 space-y-4">
                <form id="add-result-form" action="add_result_third1sem_cs.php" method="POST">
                    ...
                    dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        ...
                        <div>
                            <label for="add-cs1" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                Software Analysis (CS-3124)
                            </label>
                            <input type="number" id="add-cs1" name="CS-3124" min="0" max="100"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg 
                    focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 
                    dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 
                    dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        ...
                        <div>
                            <label for="add-cs2" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                Database System (CS-3125)
                            </label>
                            <input type="number" id="add-cs2" name="CS-3125" min="0" max="100"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg 
                    focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 
                    dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 
                    dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        ...
                        <div>
                            <label for="add-cssk1" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                Web Development (CS(SK)-3156)
                            </label>
                            <input type="number" id="add-cssk1" name="CS(SK)-3156" min="0" max="100"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg 
                    focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 
                    dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 
                    dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
...
<div id="edit-result-modal" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full items-center justify-center bg-gray-900/50">
    <div class="relative w-full max-w-2xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <!-- Modal body -->
            <div class="p-6 space-y-4">
                <form id="edit-result-form" action="update_result_third1sem_cs.php" method="POST">
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                            <label for="edit-cs1" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Software Analysis (CS-3124)</label>
                            <input type="number" id="edit-cs1" min="0" max="100" name="CS-3124" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        </div>
                        <div>
                            <label for="edit-cs2" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Database System (CS-3125)</label>
                            <input type="number" id="edit-cs2" min="0" max="100" name="CS-3125" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        </div>
                        <div>
                            <label for="edit-cssk1" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Web Development (CS(SK)-3156)</label>
                            <input type="number" id="edit-cssk1" min="0" max="100" name="CS(SK)-3156" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        </div>
                        <div>
